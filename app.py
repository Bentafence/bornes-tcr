...
# Heure de saturation habituelle (décimale) — basé sur 4 jours ouvrés
HISTO_SAT_H = {'P2':7.75,'P3':None,'P4':7.5,'P5':7.5,'P6':7.58,'P8':7.75,'P18':8.0,'P19':None}

# Occupation % par heure — 4 jours ouvrés (lundi–jeudi 23–26 mars 2026)
OCC = {
    'P2':   {7:84, 8:97, 9:97, 10:97, 11:97, 12:97, 13:98, 14:100,15:100,16:100,17:100,18:100,19:100},
    'P3':   {7:80, 8:97, 9:97, 10:97, 11:96, 12:96, 13:96, 14:98, 15:97, 16:86, 17:66, 18:36, 19:16},
    'P4':   {7:92, 8:98, 9:98, 10:97, 11:98, 12:97, 13:100,14:99, 15:92, 16:92, 17:72, 18:37, 19:11},
    'P5':   {7:82, 8:100,9:88, 10:82, 11:84, 12:87, 13:90, 14:90, 15:88, 16:85, 17:91, 18:74, 19:29},
    'P6':   {7:61, 8:100,9:100,10:99, 11:100,12:99, 13:98, 14:99, 15:98, 16:94, 17:76, 18:42, 19:9},
    'P8':   {7:32, 8:95, 9:100,10:100,11:93, 12:93, 13:93, 14:100,15:100,16:77, 17:63, 18:29, 19:9},
    'P18':  {7:92, 8:97, 9:97, 10:97, 11:93, 12:95, 13:96, 14:100,15:94, 16:91, 17:73, 18:45, 19:12},
    'P19':  {h:100 for h in range(7,20)},
    'TOTAL':{7:75, 8:98, 9:97, 10:96, 11:95, 12:96, 13:97, 14:98, 15:96, 16:90, 17:76, 18:48, 19:19},
}

# Attente midi (11h–14h) — 4 jours ouvrés
...
for p in ORDRE:
    ...
    rows_html.append(f"""<tr>
      <td><b>{p}</b></td><td>{KW[p]}</td><td>{statut}</td>
      <td>{places}</td><td>{occ_str}</td><td>{sat_html}</td>
    </tr>""")
...
fig.add_trace(go.Scatter(x=h_labels, y=moy, name='Moyenne historique',
    mode='lines', line=dict(color='#4a90d9', width=2.5, dash='dot'),
    hovertemplate='Moyenne : %{y}%<extra></extra>'))
fig.add_trace(go.Scatter(x=h_labels, y=reel, name='Maintenant',
    mode='markers', marker=dict(color='white', size=13, symbol='diamond',
...
fig.update_layout(
    ...
    margin=dict(t=10, b=10), height=400, hovermode='x unified',
)
st.plotly_chart(fig, use_container_width=True)
st.caption("Basé sur 4 jours ouvrés (lundi–jeudi, semaine 13). Les zones s'affineront avec plus de données.")
